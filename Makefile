...
#    Updated: 2024/02/14 17:55:35 by frdal-sa         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
$(NAME) : $(OBJ)
	...
	$(CC) $(OBJ) $(FLAGS) $(LIBFT) $(PRINTF)  -o minishell -lreadline 
#-lhistory -L /Users/$(USER)/.brew/opt/readline/lib -I /Users/$(USER)/.brew/opt/readline/include
	mkdir -p $(OBJ_DIR)
	mv $(OBJ) $(OBJ_DIR)
